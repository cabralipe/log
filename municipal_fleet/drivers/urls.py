...
from drivers.views import (
    ...
    DriverPortalInspectionView,
    DriverPortalNotificationsView,
    DriverPortalNotificationDeviceView,
    DriverPortalTripCompleteView,
    DriverPortalTripStartView,
...
urlpatterns = [
    ...
    path("portal/trips/<int:trip_id>/start/", DriverPortalTripStartView.as_view(), name="driver-portal-trip-start"),
    ...
    path("portal/inspections/", DriverPortalInspectionView.as_view(), name="driver-portal-inspections"),
    path("portal/notifications/", DriverPortalNotificationsView.as_view(), name="driver-portal-notifications"),
    path("portal/notifications/device/", DriverPortalNotificationDeviceView.as_view(), name="driver-portal-notification-device"),
    ...
    path("portal/gps/ping/", DriverPortalGpsPingView.as_view(), name="driver-portal-gps-ping"),
]
