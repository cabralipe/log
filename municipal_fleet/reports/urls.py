...
urlpatterns = [
    ...
    path("fuel-costs/", FuelCostReportView.as_view(), name="fuel-costs-report"),
    path("tco/", TcoReportView.as_view(), name="tco-report"),
    ...
    path("school-transport/", SchoolTransportReportView.as_view(), name="school-transport-report"),
]
