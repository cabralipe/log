  ...
  useEffect(() => {
    ...
    api
      ...
      .then((res) => {
        ...
        if (bounds) {
          allMapRef.current!.fitBounds((bounds as any).pad(0.2));
        }
      })
      .finally(() => {
            ...
            <div className="tracking-filter__list">
              ...
              {filteredDriverOptions.map((driver) => {
                ...
                return (
                  <label
                    key={driver.driverId}
                    className={`tracking-filter__item ${isSelected ? "is-selected" : ""} ${isDisabled ? "is-disabled" : ""
                      }`}
                  >
                    <input
                      type="checkbox"
            ...
            return (
              <div key={driverId} className="driver-map-card">
                ...
                <div className="driver-map-card__controls">
                  ...
                  <button
                    type="button"
                    className={`driver-map-card__button ${centerPickDriverId === driverId ? "is-active" : ""
                      }`}
                    onClick={() =>
