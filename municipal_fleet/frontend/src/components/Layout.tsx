...
export const Layout = ({ children }: { children: React.ReactNode }) => {
  ...
  const navItems = [
    ...
    ...(isAdmin ? [{ to: "/form-templates", label: "Formulários", icon: ClipboardList }] : []),
    ...(isAdmin ? [{ to: "/form-submissions", label: "Submissões", icon: ClipboardList }] : []),
    ...(isAdmin ? [{ to: "/student-cards", label: "Carteirinhas", icon: IdCard }] : []),
